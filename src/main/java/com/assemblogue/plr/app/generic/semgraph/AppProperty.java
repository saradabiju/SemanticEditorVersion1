...
public final class AppProperty {
    ...
    //　関係性ボタン
    public static String BOX_STYLE_REL_BTN = "-fx-background-color:rgb(67,186,243); -fx-border-style:solid; -fx-border-width:1.0; -fx-border-insets:0; -fx-border-color:black;";
    //  トップレベルノード追加ボタン
    public static  String ADD_TOP_NODE_BTN_STYLE = "-fx-background-color:rgb(67,186,243); -fx-border-width:0.0; -fx-border-insets:0;";
    //  右側ノード追加ボタン
    public static  String ADD_RIGHT_NODE_BTN_STYLE = "-fx-background-color:rgb(67,186,243); -fx-border-style:solid;";
    //  右側ノード追加ボタン(非表示)
    public static  String ADD_RIGHT_NODE_HIDDEN_BTN_STYLE = "-fx-text-fill:white; -fx-background-color:white; -fx-border-style:none;";

    // 関係性メニュー　項目ラベル
    public static String REL_BOX_STYLE = "-fx-background-color:rgb(220, 224, 204); -fx-border-style:solid; -fx-border-width:1.0; -fx-border-insets:0; -fx-border-color:white;";
