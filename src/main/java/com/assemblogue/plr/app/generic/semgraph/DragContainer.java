...
public class DragContainer implements Serializable {
	...
	public static final DataFormat AddAttribute =
			new DataFormat("application.NodeLink.linkattribute.add");
	public static final DataFormat DragAttribute =
			new DataFormat("application.NodeLink.attribute.drag");
