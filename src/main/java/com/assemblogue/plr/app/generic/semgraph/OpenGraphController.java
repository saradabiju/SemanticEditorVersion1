...
//System.out.println("Entered in listing values");
        // ルート直下のグラフを取得し、アイテムに登録
        for(PlrActor.NodeName pnn: appcontroller.plrAct.getRootNodeList()) {

        	//System.out.println("pnn.name"+pnn.name);
        	//System.out.println("pnn.uri"+pnn.uri);
        	//System.out.println("pnn.id"+pnn.id);
        	//System.out.println("pnn.node"+pnn.node);
        	//System.out.println("comment"+pnn.node.getComment());
        	//System.out.println("Title"+pnn.node.getTitle());
        	//System.out.println("getReferredPropertyName"+pnn.node.getReferredPropertyName());
