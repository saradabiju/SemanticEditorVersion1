...
public class NodePainController {
    ...
    private String[] btnText = {"node.btn.refresh", "graph.open.graph.list", "nodepain.btn.nodelist" };
    ...
    public void createGraphArea(String nd_name) {
    	...
    	System.out.println("entered in create grapharea"+nd_name);
    	RootLayout root = new RootLayout(graphAct);
    	ZoomableScrollPane scrollpane = new ZoomableScrollPane(root.getRightPane());
    	...
    	Scene scene = new Scene(scrollpane,Utils.getWindowWidth(), Utils.getWindowHeight());
